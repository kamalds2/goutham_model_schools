<div id="layout-wrapper">
    <div class="main-content">  
        ...
        <div class="container-fluid"> 
            <div class="row mt-n5">                 
                <div class="card">            
                    <form id="addPagesForm" autocomplete="off" class="needs-validation p-2" novalidate method="post" action="<?php echo SITEURL?>aboutpages/createPage" enctype="multipart/form-data" onSubmit="return validform();">
                        ...
                        <div class="d-flex flex-column gap-3">
                            <div class="row">
                                ...
                                <<div class="col-lg-12 mb-3">                                 
                                    ...
                                    <textarea class="form-control" name="page_description1" id="page_description1"></textarea>  
                                    <span class="text-danger" id="page_description-error">   </span>
                                </div> 
                                </div> <div class="col-lg-12 mb-3">                                 
                                    <label for="page_description" class="form-label">Section3:<span class="text-danger">*</span></label>
                                    <textarea class="form-control" name="page_description2" id="page_description2"></textarea>  
                                    <span class="text-danger" id="page_description-error">   </span>
                                </div> 
                                 <div class="col-lg-12 mb-3">                                 
                                <label for="image" class="form-label"> File Upload :  <span class="text-danger"> * </span> </label>
                                <input type="file" class="form-control" id="image" name="banner_image[]" multiple>
                            </div>
...
<script type="text/javascript">  
   ...
   function sendFile(file, editor, welEditable,summernotid) {
        ...
        $.ajax({
          data: data,
          type: "POST",
          url: "<?php echo SITEURL.'aboutpages/fileupload';?>",
          cache: false,
          contentType: false,
          processData: false,
