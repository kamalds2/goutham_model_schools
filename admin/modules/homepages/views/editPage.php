        ...
        <div class="container-fluid"> 
            <div class="row mt-n5"> 
                <div class="card">   
                    ...
                    <form id="editPgesForm" autocomplete="off" class="needs-validation p-2" novalidate method="post" action="<?php echo SITEURL?>homepages/updatePage" enctype="multipart/form-data" >
