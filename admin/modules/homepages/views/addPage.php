<div id="layout-wrapper">
    <div class="main-content">  
        ...
        <div class="container-fluid"> 
            <div class="row mt-n5">                 
                <div class="card">            
                    <form id="addPagesForm" autocomplete="off" class="needs-validation p-2" novalidate method="post" action="<?php echo SITEURL?>homepages/createPage" enctype="multipart/form-data" onSubmit="return validform();">
