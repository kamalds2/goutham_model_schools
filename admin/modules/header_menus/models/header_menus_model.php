...
class header_menus_model extends Model {
    ...
    public function getParentMenu($id){
        ...
        return $this->db->find("SELECT menu_name FROM ".DBPREFIX."_header_menus WHERE `menu_id` = $id");
    ...
    public function getMenuDescription1(){
     ...
     */
     ...
     public function updateMenu($data) {
        ...
        $result = $this->db->update(DBPREFIX.'_header_menus',  "`menu_id` = $id");
   ...
   public function updateMenuById($menu_id, $parent_id, $position) {
        ...
        $url = RESTURL."menus/updatemenubyid";  
        // echo $url;var_dump(json_encode($values));die();
        $result = $this->CallAPI("POST",$url,$values);
        return $result;
    ...
    public function getMenuDetails($id){
        ...
        return $this->db->find("SELECT * FROM ".DBPREFIX."_header_menus WHERE `menu_id` = :menu_id", array(':menu_id' => $id));
