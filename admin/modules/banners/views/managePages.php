                ...
                <div class="card-body pb-0 px-4">
                    <div class="container-fluid">
                        <div class="row justify-content-between align-items-center g-3 mb-5 pb-1 pt-3">
                            ...
                            <div class="col-lg-2">
                                <a type="button" class="btn btn-primary w-100 addContact-modal" href="<?php echo SITEURL?>banners/addPage"  ><i class="bi bi-plus align-middle"></i> Add Banners</a>
                            </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="alternative-pagination" class="table dataTable table-dynamic filter-footer" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php $this->bannersList = (Array) @$this->bannersList->pages;
                                              if($this->bannersList != '') {                                               
                                              foreach($this->bannersList as $value) {
                                            ?>
                                            <tr>
                                                ...
                                                <td><span class="badge badge-soft-success"><?php echo ($value->image_status == '0') ? "Active":"In-Active";;?></span></td>
                                                <td>
                                                    <div class="d-flex align-items-left gap-2">    
                                                        <div class="editPageDetails">
                                                            <a  href="<?php echo SITEURL;?>banners/editPage/<?php echo $value->id ?>" class="text-muted px-1 d-block"><i class="bi bi-pencil-fill"></i></a>
                                                        </div>                        
                                                        <div>
                                                            <a href="javascript:void(0)"  data-id="<?php echo $value->id; ?>" class="text-muted px-1 d-block deletePage" ><i class="bi bi-trash-fill"></i></a>
                                                        </div>                      
                                                    </div>
                                                </td>
                                            </tr>
            ...
            title: "<strong>Confirmation</strong> Box",
                ...
                callback: function (result) {
                  if(result) {            
                    jQuery.ajax({
                        type: "POST",             
                        url:"<?php echo SITEURL; ?>banners/deletePage",
                        data: 'id='+ delId,
