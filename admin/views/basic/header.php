...
<html lang="en" data-layout="horizontal" data-topbar="light">
    ...
    <head> 
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="<?php echo THEMEURL;?>assets/images/favicons.png">
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-md-auto col-6 d-none d-lg-block">
                        <div class="d-flex align-items-center justify-content-center gap-3 fs-13 text-white-50">
                            <div>
                                <i class="bi bi-envelope align-middle me-2"></i> info@gowtham.org
.in
                            </div>
                            <div>
                                <i class="bi bi-globe align-middle me-2"></i> info@gowtham.org
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="index.php" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="<?php echo THEMEURL;?>assets/images/favicons.png" alt="" height="60">
                                </span>
                            </a>
        ...
        <div class="container-fluid">
           <!-- <div id="two-column-menu">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAuth" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                        <i class="ri ri-suitcase-2-line "></i> <span data-key="t-authentication">Pages</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarAuth">
                        <ul class="nav nav-sm flex-column">
                              <li class="nav-item">
                    <a href="<?php echo SITEURL?>homepages" class="nav-link menu-link">  <span data-key="t-dashboard">Home</span> </a>
                            </li>
                            <li class="nav-item ">
                                <a href="<?php echo SITEURL; ?>aboutpages" class="nav-link" data-key="t-starter"> About </a>
                            </li> 
                            <li class="nav-item">
                        <a href="<?php echo SITEURL?>otherpages" class="nav-link menu-link">  <span data-key="t-dashboard">Contact</span> </a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a href="<?php echo SITEURL?>header_menus" class="nav-link menu-link"> <i class="mdi mdi-menu"></i> <span data-key="t-dashboard">Menus</span> </a>
                </li>
                 ...
                 <li class="nav-item">
                    <a href="<?php echo SITEURL?>banners" class="nav-link menu-link"> <i class="mdi mdi-menu"></i> <span data-key="t-dashboard">Banners</span> </a>
                </li>
