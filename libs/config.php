...
define('VERSION', '1.0');
define('MAINURL', $_SERVER['DOCUMENT_ROOT']."/GouthamSchool/");
define("SITEURL", "http://" . $_SERVER['HTTP_HOST'] . '/GouthamSchool/');
define("URL", "http://" . $_SERVER['HTTP_HOST'] . str_replace("index.php/", "", $_SERVER['REQUEST_URI']));
define('BASE', $_SERVER['DOCUMENT_ROOT']."/GouthamSchool/");
define("RESTURL","http://" . $_SERVER['HTTP_HOST'] . '/GouthamSchool/'."restful/");
define('PATH', "http://" . $_SERVER['HTTP_HOST'] ."/GouthamSchool/");
