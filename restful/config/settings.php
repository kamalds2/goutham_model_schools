...
define("EXCELPATH", $_SERVER['DOCUMENT_ROOT'] . '/GouthamSchool/libs/helpers/PHPExcel_1.7.9_doc/Classes/');
define('UPLOADFILEPATH', $_SERVER['DOCUMENT_ROOT'] . '/GouthamSchool/uploads/');
define('UPLOADPATH', $_SERVER['DOCUMENT_ROOT'] . '/GouthamSchool/uploads/');
